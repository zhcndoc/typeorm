...
- **防止 SQL 注入** — 所有驱动程序在架构内省和 DDL 方法中现已使用参数化查询与转义标识符，从而防止通过数据库/模式/表/列名进行 SQL 注入 ([#12207](https://github.com/typeorm/typeorm/pull/12207) 由 [@pkuczynski](https://github.com/pkuczynski) 贡献，[#12197](https://github.com/typeorm/typeorm/pull/12197) 由 [@pkuczynski](https://github.com/pkuczynski) 贡献，[#12185](https://github.com/typeorm/typeorm/pull/12185) 由 [@pkuczynski](https://github.com/pkuczynski) 贡献)
